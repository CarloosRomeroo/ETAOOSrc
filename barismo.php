...
$secciones = array(
    array('titulo' => 'Únete!!', 'contenido' => '¡Despierta tu pasión por el café y conviértete en un maestro del barismo! Nuestro curso te brinda la oportunidad de sumergirte en el fascinante mundo de los sabores, aromas y técnicas que hacen del café una experiencia única. ¿Estás listo para convertirte en un barista excepcional?
    Desde el primer día, estarás aprendiendo las técnicas esenciales para preparar café de alta calidad. Desde espresso perfecto hasta la creación de arte latte, te convertirás en un experto en la preparación de bebidas irresistibles.'),
...
<section class="video-info">
    <div class="video-description">
        ...
        Dominarás el arte de crear diseños hermosos en la superficie de tus espressos y lattes. Desde corazones hasta hojas, aprenderás a impresionar a tus clientes con presentaciones visualmente atractivas.
        </p>
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/evyCtWJeByI?si=ivwtmUkdnSH82zav" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
