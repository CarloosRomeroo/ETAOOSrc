...
<head>
    ...
    <title>Curso de Soldadura</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => 'Únete y Aprende', 'contenido' => 'Desde los conceptos básicos hasta las técnicas avanzadas, te sumergirás en el mundo de la soldadura. Aprenderás a manejar diferentes tipos de soldadoras, entenderás los diversos métodos de soldadura y desarrollarás habilidades de precisión. 
    Aprenderás a realizar soldaduras de alta precisión, desde la unión de piezas delgadas hasta la creación de estructuras robustas. La calidad y la durabilidad serán tus principales objetivos.'),
...
<section class="video-info">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/SCGAv6PJ9Tw?si=96bapK4VvJHwv-_D" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
