...
<head>
    ...
    <title>Curso de Reposteria</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => 'Únete y Aprende', 'contenido' => 'Desarrolla tus habilidades creativas en la decoración de pasteles y postres. Desde diseños clásicos hasta tendencias contemporáneas, podrás crear obras maestras que deleiten a la vista y al paladar.Dominarás el uso de ingredientes específicos y utensilios especializados para la repostería. Aprenderás a seleccionar ingredientes de calidad y a utilizar herramientas que te ayudarán a obtener resultados perfectos.'),
...
<section class="video-info">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/1XyVTEg0tE4?si=7caU-3L9AIfW1bp1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
