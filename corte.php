...
<head>
    ...
    <title>Curso de Corte y Confección</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => '', 'contenido' => '¡Nuestro curso de corte y confección te brinda la oportunidad de explorar el mundo del diseño de moda y aprender las habilidades prácticas necesarias para convertir tus ideas en prendas con estilo. ¿Estás listo para dar vida a tus creaciones y sumergirte en el fascinante universo de la moda?'),
...
<section class="video-info">
    <div class="video-description">
        ...
        Desde los conceptos básicos hasta las habilidades avanzadas, te sumergirás en el mundo de la informática. Aprenderás a manejar sistemas operativos, programas de oficina y herramientas esenciales para la productividad.
        Conviértete en un usuario experto de la tecnología, desbloquea nuevas oportunidades laborales y destaca en un mundo cada vez más digitalizado. ¡No dejes pasar la oportunidad de potenciar tu carrera con habilidades computacionales sólidas y versátiles!
    </p>
        <h2>Nuestro Curso</h2>
        <p class="text-justify">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/QwYWah4NnXE?si=20pVTb1DHAI_j3c2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
