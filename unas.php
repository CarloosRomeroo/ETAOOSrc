...
<head>
    ...
    <title>Curso de uñas Acrílicas</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => 'Únete y Aprende', 'contenido' => '¡Dale un toque de elegancia y estilo a tu futuro con nuestro emocionante curso de uñas acrílicas! Este programa te ofrece la oportunidad de sumergirte en el fascinante mundo del diseño de uñas, donde podrás desarrollar habilidades artísticas y técnicas únicas. ¿Estás lista para darle vida a tu creatividad y convertirte en una experta en el arte de las uñas acrílicas?
    
    
    Dominarás el uso de los materiales y herramientas específicas para la aplicación de uñas acrílicas. Aprenderás a seleccionar productos de calidad y a utilizar herramientas especializadas para lograr resultados impecables.'),
...
<section class="video-info">
    ...
    <<iframe width="560" height="315" src="https://www.youtube.com/embed/rt9jQI7mKi4?si=_uK5vcNS_zMePdIA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
