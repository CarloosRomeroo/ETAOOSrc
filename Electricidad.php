...
<head>
    ...
    <title>Curso de Electricidad</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => 'Únete y Aprende', 'contenido' => 'Desde los conceptos básicos hasta los principios avanzados, te sumergirás en el mundo de la electricidad. Aprenderás sobre circuitos, corriente eléctrica, resistencia y voltaje de manera práctica y aplicada.
    Dominarás el uso de herramientas eléctricas y equipos especializados. Desde multímetros hasta dispositivos de medición, desarrollarás habilidades para trabajar con precisión y seguridad.'),
...
<section class="video-info">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/aJY54swfWng?si=QBG6PLaQAFBqQM1x" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
