...
<head>
    ...
    <title>Curso de Refrigeración</title>
    <style>
        body {
...
$secciones = array(
    array('titulo' => 'Únete y Aprende', 'contenido' => 'Desde los principios básicos hasta los conceptos avanzados, te sumergirás en el funcionamiento de los sistemas de refrigeración. Aprenderás sobre ciclos de refrigeración, compresores, condensadores y evaporadores.'),
...
<section class="video-info">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/hfWc_4InUns?si=pV-iZLpuukVbbNdP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</section>
